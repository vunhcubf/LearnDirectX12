...
public:
	...
	Mesh(Graphics* graphics, const std::vector<Vertex_POS_COLOR_UV1_UV2_Normal_Tangent>& Vertices, const std::vector<UINT>& Indices, UINT CountOfVertices, UINT CountOfIndices, const CBufferPerObject& CBufferData, D3D_PRIMITIVE_TOPOLOGY PrimitiveTopology = D3D_PRIMITIVE_TOPOLOGY_TRIANGLELIST) {
	...
	D3D12_VERTEX_BUFFER_VIEW* GetVertexBufferViewPtr() { &VertexBufferView; }
	D3D12_INDEX_BUFFER_VIEW* GetIndexBufferViewPtr() { &IndexBufferView; }
